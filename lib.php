...
class format_glendon extends format_base {
    ...
    /**
     * Returns the default section name for the glendon course format.
     *
    ...
    public function get_default_section_name($section) {
        if ($section->section == 0) {
            ...
            return get_string('section0name', 'format_glendon');
        } else {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['numsections']['label'])) {
            ...
            $courseformatoptionsedit = array(
                ...
                'collapsed' => array(
                    'label' => new lang_string('collapsed', 'format_glendon'),
                    'element_type' => 'select',
                    'element_attributes' => array(
                        array(
                            1 => get_string('yes'),
     ...
     *
     * In case if course format was changed to 'glendon', we try to copy options
    ...
    public function course_content_header() {
        ...
        if (strstr($url, 'mod') && !strstr($url,'adobeconnect/participants.php')) {
            //Add font-awesome
